                                        ...
                                        <div class="row m-5">
                                            <div class="col-lg-12">
                                                <div class="form-group m-5 h3">
                                                    <i class="fa fa-thumbs-o-down"></i>  <?=                                                    base64_decode($_GET['e']); ?>
                                                    <a href="../" class="nav-link" >
                                                        Click Here</a>  to go back to Home
                                                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="conf_fee.php">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="name" placeholder="Your Title and Name">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="emailid" placeholder="Your Email Address">
                                    </div>
                                    ...
                                    <div class="form-group">If you are a member of NSPS, enter your Membership Number, otherwise leave the space empty
                                        <input type="text" class="form-control" name="phoneumber" placeholder="Your Membership Number">
                                    </div>

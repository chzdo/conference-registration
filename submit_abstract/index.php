                ...
                <section id="buy-tickets" class="section-with-bg wow fadeInUp">
                    <div class="container ">
                        ...
                        <div class="section-header">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group m-5">
                                                <div >
                                                    ...
                                                    <form  id="uploadabs" class="p-4 m-5" method="post" action="index.php" enctype="multipart/form-data">
                                                        <hr>
                                                        <div class="form-group m-5">
                                                        ...
                                                        <div class="form-group m-5">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <label class="form-control"> Select PDF File
                                                                    <input type="file" style=""  required="" name="paper_pdf" class = "" id="paper_pdf" >
                                                                </label>
                                                            </div>
                                                        </div> 
                                                        <div class="form-group m-5">
                                                          ...
                                                          <div class="form-group m-5">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" style="" name="co_author" class = "form-control input-lg" id="username" placeholder="Co-Author(S) example Ndiama, K.C., Mohammed M.S., and Oluwatosin M.P."   value="">

                                                            </div>
                                                        </div> 
                                                        <div class="text-center">
                                                            <div style="padding:10px;" align="center"> 
                                                                <button type="submit" id='absbtn' class="btn btn_add_new btn-success shadow ">SUBMIT ABSTRACT</button> <div id="spin" class="loader"></div>
                                                            </div>
                                                            <label id='error' class="alert alert-info form-control" > <?= @$error ?></label>
                                                    </form>
                                                    <hr>
                                                </div>
                                            </div>
                            ...
                            <?php } else {
                                echo "<script type='text/javascript'>document.location.href='../payment/';</script>";
                            }
                            ?>
                        </div>

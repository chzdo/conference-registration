...
if (isset($_SESSION['author'])) {
  ...
  //  $_SESSION['presenter_login'] = $_SESSION['author'];
...
<body>
    <div style="text-align: center;">
        <?php if($response_code == '01' || $response_code == '00') {$query = "update conf set priv='1',rrr='$rrr',orderID ='$orderID' where  email = '".$_SESSION['author']."';";
